...
<body>
	...
	`).join(``)}
	${i(c)}
</body></html>`}function s(i,o){let s=`Week ${i.week_number} — ${i.theme||`Plan`}`,c=new Date(i.week_start+`T00:00:00`).toLocaleDateString(`en-US`,{month:`short`,day:`numeric`}),l=new Date(i.week_end+`T00:00:00`).toLocaleDateString(`en-US`,{month:`short`,day:`numeric`,year:`numeric`});return`<!DOCTYPE html>
<html lang="en">
