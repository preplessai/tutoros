...
app.post('/api/stripe/webhook', async (c) =>
	handleWebhook(c.req.raw, c.env as Record<string, string>)
);
...
app.post('/api/stripe/create-checkout-session', async (c) =>
	handleCreateCheckoutSession(c.req.raw, c.env as Record<string, string>)
);
app.post('/api/stripe/create-portal-session', async (c) =>
	handleCreatePortalSession(c.req.raw, c.env as Record<string, string>)
);
