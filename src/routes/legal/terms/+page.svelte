...
<section class="py-16 md:py-24 bg-[var(--color-surface)]">
  <div class="container-page max-w-3xl">
    <div class="animate-fade-in-up">
      ...
      <h1 class="text-4xl md:text-5xl font-bold text-[var(--color-text-primary)] font-[family-name:var(--font-heading)] mb-8">Terms of Service</h1>
    ...
    <div class="prose prose-lg max-w-none space-y-8 text-[var(--color-text-secondary)]">
      ...
      <div class="animate-fade-in-up" style="animation-delay:0.15s">
        <h2 class="text-xl font-semibold text-[var(--color-text-primary)] font-[family-name:var(--font-heading)]">3. User Responsibilities</h2>
      ...
      <div class="animate-fade-in-up" style="animation-delay:0.2s">
        <h2 class="text-xl font-semibold text-[var(--color-text-primary)] font-[family-name:var(--font-heading)]">4. AI-Generated Content</h2>
        <p>The Service uses artificial intelligence to generate tutoring schedules and resource recommendations. AI-generated content is provided as suggestions only and may contain errors, omissions, or inappropriate recommendations. You are solely responsible for reviewing and approving all AI-generated content before use.</p>
      </div>
      ...
      <div class="animate-fade-in-up" style="animation-delay:0.35s">
        <h2 class="text-xl font-semibold text-[var(--color-text-primary)] font-[family-name:var(--font-heading)]">7. Termination</h2>
        <p>We reserve the right to suspend or terminate accounts that violate these Terms or engage in prohibited conduct.</p>
      </div>

      <div class="animate-fade-in-up" style="animation-delay:0.4s">
        <h2 class="text-xl font-semibold text-[var(--color-text-primary)] font-[family-name:var(--font-heading)]">8. Changes to Terms</h2>
