...
<div class="mx-auto grid max-w-5xl gap-8 md:grid-cols-3">
	{#each plans as plan}
		<Card padding={false} hover={plan.highlighted}>
			...
			>
				<div
					class={`p-6 ${plan.highlighted ? 'rounded-[0.625rem] bg-[var(--color-surface-elevated)]' : ''}`}
				>
					{#if plan.highlighted}
						<div
...
<div class="mx-auto mt-24 max-w-3xl">
	<div class="mb-10 text-center">
		...
		<p class="mx-auto mt-3 max-w-lg text-base text-[var(--color-text-secondary)]">
			Need more credits? Top up anytime. Credits never expire. Pro & Enterprise members get <strong
				...
				<thead>
					<tr class="border-b-2 border-[var(--color-border)]">
						<th
							...
							>Pack</th
						>
						<th class="px-4 py-3 text-center font-semibold text-[var(--color-text-secondary)]"
							>Starter</th
						>
						<th class="px-4 py-3 text-center font-semibold text-[var(--color-text-primary)]">
				...
				<tbody>
					{#each payAsYouGoPacks as pack}
						...
						>
							...
							<td class="bg-[var(--color-primary-50)]/50 px-4 py-4 text-center">
...
<div class="mx-auto mt-20 max-w-2xl">
	...
	<div class="grid gap-6 sm:grid-cols-3">
		...
		<div class="text-center">
			...
			<p class="mt-1 text-xs text-[var(--color-text-secondary)]">
				Pro & Enterprise credits <strong>refresh monthly</strong>. Unused credits do not roll over
			</p>
		</div>
		<div class="text-center">
			<div
			...
			<p class="mt-1 text-xs text-[var(--color-text-secondary)]">
				Buy extra credit packs anytime. <strong>Never expire.</strong> Pro members get bonus credits
			</p>
		</div>
	</div>
</div>
