...
<form onsubmit={handleRegister} class="space-y-5">
	...
	<Input label="Name" name="displayName" type="text" placeholder="Your name" required bind:value={displayName} />
	<Input label="Email" name="email" type="email" placeholder="you@example.com" required bind:value={email} />
	<Input label="Password" name="password" type="password" placeholder="At least 8 characters" required bind:value={password} />

	<Button type="submit" variant="gradient" size="lg" fullWidth {loading}>
	...
	<Button variant="outline" size="lg" fullWidth onclick={handleGoogleRegister} disabled={loading}>
